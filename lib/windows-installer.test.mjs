...
test('Windows installer reads the v0.1.0 GitHub release asset from config/links.json', () => {
  ...
  assert.equal(links.downloadForWindowsFile, 'Athena-Setup-0.1.0-x64.exe');
  assert.equal(
    links.downloadForWindows,
    'https://github.com/ANNJUNGCHAN/DAOU.Athena/releases/download/v0.1.0/Athena-Setup-0.1.0-x64.exe',
  );
